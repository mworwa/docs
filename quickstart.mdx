...
Visit dashboard and create agent. For beginning you can use ready made Agent for example "Sentiment".
...
After creating Agent You will be redirected to Edit Agent Page where you can copy Agent ID

<img
  className="block"
  src="/images/copy-agent-id.png"
  alt="Copy Agent ID"
/>
